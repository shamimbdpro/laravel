...
<section class="slider" style="background: url({{asset('public/uploads/')}}/{{$ban->ban_photo}}) no-repeat scroll 0 0 / 100% 100%;">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="block">
					<h1 class="animated fadeInUp">{{$ban->ban_title}}</h1>
					<p class="animated fadeInUp">{{$ban->ban_subtitle}}</p>
					<a href="{{$ban->ban_subtitle}}" target="_blank" class="btn btn-main animated fadeInUp">{{$ban->btn}}</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-5 col-sm-12">
				<div class="block">
					<img src="{{asset('public/contents/website')}}/images/wrapper-img.png" alt="Img">
				</div>
			</div><!-- .col-md-5 close -->
		</div>
	</div>
        ...
        <div class="testimonial-carousel text-center">
          <div  class="testimonial-slider owl-carousel">
            <div>
              ...
              <div class="user">
                <img src="{{asset('public/contents/website')}}/images/item-img1.jpg" alt="Pepole">
